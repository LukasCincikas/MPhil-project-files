        ...
        p_subject_chooses_red[t] = pChooseRed(proportion_red, alpha, red_bias);

        // --------------------------------------------------------------------
        // (b) Predict how much was bet.
        // --------------------------------------------------------------------
        // Our prediction for proportion_staked is conditional upon the choice
        // of colour, and so we're allowed to know which colour the subject
        // actually chose.
        ...
        target += bernoulli_lpmf(chose_red[t] | p_subject_chooses_red[t]);
