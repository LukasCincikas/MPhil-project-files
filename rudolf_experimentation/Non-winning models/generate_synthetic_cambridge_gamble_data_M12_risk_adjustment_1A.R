...
makeSingleRun <- function(alpha, red_bias, gamma, rho, beta, theta)
{
...
makeSpecimensWithinSubjects <- function(n_subjects_per_group = 25, seed = NULL)
{
  ...
  write.csv(
    data_holder,
    file = file.path(SYNTHETIC_DATA_DIR, "mock_data_rnc_2x2groups_M12_risk_adjustment_1A.csv"),
    row.names = FALSE
  )
}
