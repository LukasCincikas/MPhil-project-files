...
generated quantities {
    ...
    real overall_group_effect_delta;
    ...
    
    {
        ...
        overall_group_effect_delta = (group_mean_delta[1] + group_mean_delta[2]) / 2 - (group_mean_delta[3] + group_mean_delta[4]) / 2;
        ...
        overall_condition_effect_delta = (group_mean_delta[1] + group_mean_delta[3]) / 2 - (group_mean_delta[2] + group_mean_delta[4]) / 2;
    }
}
