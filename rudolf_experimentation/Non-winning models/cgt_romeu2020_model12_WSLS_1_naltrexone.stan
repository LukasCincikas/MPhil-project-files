// cgt_romeu2020_model12_WSLS_1.stan
...
parameters {
    ...
    vector[N_GROUPS*N_CONDITIONS] nspace1_group_mean_phi;
    ...
    vector<lower=0>[N_GROUPS] nspace1_group_sd_phi;
    ...
    vector[N_SEGMENTS] nspace2_subject_effect_phi;
...
transformed parameters {
    ...
    vector<lower=0>[N_SUBJECTS] subject_phi;
    ...
    for (s in 1:N_SUBJECTS) {
        ...
        real nspace1_subject_effect_phi;
        real nspace1_subject_phi;
        ...
        nspace1_subject_effect_phi =
            nspace2_subject_effect_phi[sgm] * nspace1_group_sd_phi[g];
        nspace1_subject_phi =
            nspace1_group_mean_phi[p] + nspace1_subject_effect_phi;
        subject_phi[s] = exp(nspace1_subject_phi);
...
#include /include_model_declarations.stan
    ...
    sampleNormal_VRR_lp(nspace1_group_mean_phi,      0, 1);
    ...
    sampleNormalLowerBound_VRR_lp(nspace1_group_sd_phi,      0, PRIOR_SD_FOR_GROUP_STANDARD_NORMAL, 0);
    ...
    sampleNormal_VRR_lp(nspace2_subject_effect_phi,      0, 1);

    // ========================================================================
    // Cognitive model
    // ========================================================================

#include /include_model_core_romeu2020_m12_WSLS_1.stan
...
generated quantities {
    ...
    vector<lower=0>[N_GROUPS*N_CONDITIONS] group_mean_phi;
    ...
    matrix[N_GROUPS*N_CONDITIONS, N_GROUPS*N_CONDITIONS] group_mean_diff_phi;
    ...
    matrix[N_GROUPS, N_GROUPS] group_sd_diff_nspace1_phi;
    ...
    real overall_group_effect_phi_control_alcohol;
    ...
    real overall_group_effect_phi_control_poly;
    ...
    real overall_group_effect_phi_alcohol_poly;
    ...
    real overall_condition_effect_phi;
    ...
    group_mean_phi = exp(nspace1_group_mean_phi);
    
    {
        ...
        for (g1 in 1:(N_GROUPS*N_CONDITIONS)) {
            for (g2 in 1:(N_GROUPS*N_CONDITIONS)) {
                ...
                if (g1 == g2) {
                    ...
                    group_mean_diff_phi[g1, g2]      = tiny_random_number;
                    ...
                    group_mean_diff_phi[g1, g2]      = group_mean_phi[g1]      - group_mean_phi[g2];
                }
            }
        }
        ...
        for (g1 in 1:(N_GROUPS)) {
            for (g2 in 1:(N_GROUPS)) {
                ...
                if (g1 == g2) {
                    ...
                    group_sd_diff_nspace1_phi[g1, g2]      = tiny_random_number;
                    ...
                    group_sd_diff_nspace1_phi[g1, g2]      = nspace1_group_sd_phi[g1]      - nspace1_group_sd_phi[g2];
                }
            }
        }
        ...
        overall_group_effect_phi_control_alcohol = (group_mean_phi[1] + group_mean_phi[2]) / 2 - (group_mean_phi[3] + group_mean_phi[4]) / 2;
        ...
        overall_group_effect_phi_control_poly = (group_mean_phi[1] + group_mean_phi[2]) / 2 - (group_mean_phi[5] + group_mean_phi[6]) / 2;
        ...
        overall_group_effect_phi_alcohol_poly = (group_mean_phi[3] + group_mean_phi[4]) / 2 - (group_mean_phi[5] + group_mean_phi[6]) / 2;
        ...
        overall_condition_effect_phi = (group_mean_phi[1] + group_mean_phi[3] + group_mean_phi[5]) / 3 - (group_mean_phi[2] + group_mean_phi[4] + group_mean_phi[6]) / 3;
    }
}