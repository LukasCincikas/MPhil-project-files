// cgt_romeu2020_model3_single_subject.stan
...
parameters {
    ...
    vector[N_GROUPS*N_CONDITIONS] nspace1_group_mean_delta;
    ...
    vector<lower=0>[N_GROUPS] nspace1_group_sd_delta;
    ...
    vector[N_SEGMENTS] nspace2_subject_effect_delta;
...
transformed parameters {
    ...
    vector<lower=0>[N_SUBJECTS] subject_delta;
    ...
    for (s in 1:N_SUBJECTS) {
        ...
        real nspace1_subject_effect_delta;
        real nspace1_subject_delta;
        ...
        nspace1_subject_effect_delta =
            nspace2_subject_effect_delta[sgm] * nspace1_group_sd_delta[g];
        nspace1_subject_delta =
            nspace1_group_mean_delta[p] + nspace1_subject_effect_delta;
        subject_delta[s] = exp(nspace1_subject_delta);
...
#include /include_model_declarations.stan
    ...
    sampleNormal_VRR_lp(nspace1_group_mean_delta,    0, 1);
    ...
    sampleNormalLowerBound_VRR_lp(nspace1_group_sd_delta,    0, PRIOR_SD_FOR_GROUP_STANDARD_NORMAL, 0);
    ...
    sampleNormal_VRR_lp(nspace2_subject_effect_delta,    0, 1);

    // ========================================================================
    // Cognitive model
    // ========================================================================

#include /include_model_core_romeu2020_m3.stan
...
generated quantities {
    ...
    vector<lower=0>[N_GROUPS*N_CONDITIONS] group_mean_delta;
    ...
    matrix[N_GROUPS*N_CONDITIONS, N_GROUPS*N_CONDITIONS] group_mean_diff_delta;
    ...
    matrix[N_GROUPS, N_GROUPS] group_sd_diff_nspace1_delta;
    ...
    real overall_group_effect_delta_control_alcohol;
    ...
    real overall_group_effect_delta_control_poly;
    ...
    real overall_group_effect_delta_alcohol_poly;
    ...
    real overall_condition_effect_delta;
    ...
    group_mean_delta = exp(nspace1_group_mean_delta);
    
    {
        ...
        for (g1 in 1:(N_GROUPS*N_CONDITIONS)) {
            for (g2 in 1:(N_GROUPS*N_CONDITIONS)) {
                ...
                if (g1 == g2) {
                    ...
                    group_mean_diff_delta[g1, g2]    = tiny_random_number;
                    ...
                    group_mean_diff_delta[g1, g2]    = group_mean_delta[g1]    - group_mean_delta[g2];
                }
            }
        }
        ...
        for (g1 in 1:(N_GROUPS)) {
            for (g2 in 1:(N_GROUPS)) {
                ...
                if (g1 == g2) {
                    ...
                    group_sd_diff_nspace1_delta[g1, g2]    = tiny_random_number;
                    ...
                    group_sd_diff_nspace1_delta[g1, g2]    = nspace1_group_sd_delta[g1]    - nspace1_group_sd_delta[g2];
                }
            }
        }
        ...
        overall_group_effect_delta_control_alcohol = (group_mean_delta[1] + group_mean_delta[2]) / 2 - (group_mean_delta[3] + group_mean_delta[4]) / 2;
        ...
        overall_group_effect_delta_control_poly = (group_mean_delta[1] + group_mean_delta[2]) / 2 - (group_mean_delta[5] + group_mean_delta[6]) / 2;
        ...
        overall_group_effect_delta_alcohol_poly = (group_mean_delta[3] + group_mean_delta[4]) / 2 - (group_mean_delta[5] + group_mean_delta[6]) / 2;
        ...
        overall_condition_effect_delta = (group_mean_delta[1] + group_mean_delta[3] + group_mean_delta[5]) / 3 - (group_mean_delta[2] + group_mean_delta[4] + group_mean_delta[6]) / 3;
    }
}
