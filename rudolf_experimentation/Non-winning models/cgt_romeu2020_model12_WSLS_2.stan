...
#include /include_model_core_romeu2020_m12_WSLS_2.stan
...
generated quantities {
    ...
    
    {
        ...
        overall_group_effect_phi = (group_mean_phi[1] + group_mean_phi[2]) / 2 - (group_mean_phi[3] + group_mean_phi[4]) / 2;
        ...
        overall_condition_effect_phi = (group_mean_phi[1] + group_mean_phi[3]) / 2 - (group_mean_phi[2] + group_mean_phi[4]) / 2;
    }
}
