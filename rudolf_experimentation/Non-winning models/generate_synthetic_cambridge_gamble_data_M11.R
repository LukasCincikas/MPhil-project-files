...
# generate_synthetic_cambridge_gamble_data_M11.R
#
...
makeSpecimens <- function(n_subjects_per_group = 50, seed = NULL)
{
  ...
  write.csv(
    ...
    file = file.path(SYNTHETIC_DATA_DIR, "mock_data_rnc_1subject_M11.csv"),
    row.names = FALSE
  )
  write.csv(
    rbind(
    ...
    file = file.path(SYNTHETIC_DATA_DIR, "mock_data_rnc_2subjects_M11.csv"),
    row.names = FALSE
  )
  write.csv(
    makeMultipleSubjectsSameParameters(
    ...
    file = file.path(SYNTHETIC_DATA_DIR, "mock_data_rnc_1group_M11.csv"),
    row.names = FALSE
  )
  write.csv(
    rbind(
    ...
    file = file.path(SYNTHETIC_DATA_DIR, "mock_data_rnc_2groups_M11.csv"),
    row.names = FALSE
  )
}
...
makeSpecimensWithinSubjects <- function(n_subjects_per_group = 25, seed = NULL)
{
  ...
  write.csv(
    data_holder,
    file = file.path(SYNTHETIC_DATA_DIR, "mock_data_rnc_2x2groups_M11.csv"),
    row.names = FALSE
  )
}
