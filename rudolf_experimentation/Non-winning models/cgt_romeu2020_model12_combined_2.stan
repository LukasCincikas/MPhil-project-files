...
transformed parameters {
    ...
    vector<lower=0>[N_SUBJECTS] subject_zeta;
    ...
    for (s in 1:N_SUBJECTS) {
        ...
        subject_zeta[s] = exp(nspace1_subject_zeta);
...
#include /include_model_core_romeu2020_m12_combined_2.stan
...
generated quantities {
    ...
    vector<lower=0>[N_GROUPS*N_CONDITIONS] group_mean_zeta;
    ...
    group_mean_zeta = exp(nspace1_group_mean_zeta);
