...
pChooseRed <- function(proportion_red_offered, alpha)
{
...
makeSingleRun <- function(alpha, gamma, rho, beta)
{
...
makeSpecimensWithinSubjects <- function(n_subjects_per_group = 25, seed = NULL)
{
  ...
  write.csv(
    data_holder,
    file = file.path(SYNTHETIC_DATA_DIR, "mock_data_rnc_2x2groups_M12_simplified_colour_choice.csv"),
    row.names = FALSE
  )
}
