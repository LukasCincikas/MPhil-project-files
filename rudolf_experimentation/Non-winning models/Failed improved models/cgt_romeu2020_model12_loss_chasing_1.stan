...
transformed parameters {
    ...
    for (s in 1:N_SUBJECTS) {
        ...
        subject_rho[s] = nspace1_subject_rho;
...
#include /include_model_core_romeu2020_m12_loss_chasing_1.stan
...
generated quantities {
    ...
    vector[N_GROUPS*N_CONDITIONS] group_mean_rho;
    ...
    group_mean_rho = nspace1_group_mean_rho;
