// cgt_romeu2020_model12_loss_chasing_1.stan
...
transformed parameters {
    ...
    vector<lower=0>[N_SUBJECTS] subject_theta;
    ...
    for (s in 1:N_SUBJECTS) {
        ...
        subject_theta[s] = exp(nspace1_subject_theta);
...
#include /include_model_core_romeu2020_m12_loss_chasing_3.stan
...
generated quantities {
    ...
    vector<lower=0>[N_GROUPS*N_CONDITIONS] group_mean_theta;
    ...
    group_mean_theta = exp(nspace1_group_mean_theta);
