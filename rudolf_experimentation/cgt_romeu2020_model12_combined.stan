// cgt_romeu2020_model12_combined.stan
// Used for the winning model using the 2 additional parameters
// For 2 conditions x 2 groups data structure 
...
generated quantities {
    ...
    real overall_group_effect_theta;
    real overall_group_effect_zeta;
    
    real placebo_group_effect_alpha;
    real placebo_group_effect_red_bias;
    real placebo_group_effect_gamma;
    real placebo_group_effect_rho;
    real placebo_group_effect_beta;
    real placebo_group_effect_theta;
    real placebo_group_effect_zeta;
    
    real drug_group_effect_alpha;
    real drug_group_effect_red_bias;
    real drug_group_effect_gamma;
    real drug_group_effect_rho;
    real drug_group_effect_beta;
    real drug_group_effect_theta;
    real drug_group_effect_zeta;
    ...
    real control_condition_effect_alpha;
    real control_condition_effect_red_bias;
    real control_condition_effect_gamma;
    real control_condition_effect_rho;
    real control_condition_effect_beta;
    real control_condition_effect_theta;
    real control_condition_effect_zeta;
    
    real experim_condition_effect_alpha;
    real experim_condition_effect_red_bias;
    real experim_condition_effect_gamma;
    real experim_condition_effect_rho;
    real experim_condition_effect_beta;
    real experim_condition_effect_theta;
    real experim_condition_effect_zeta;
    ...
    
    {
        ...
        overall_group_effect_theta = (group_mean_theta[1] + group_mean_theta[2]) / 2 - (group_mean_theta[3] + group_mean_theta[4]) / 2;
        overall_group_effect_zeta = (group_mean_zeta[1] + group_mean_zeta[2]) / 2 - (group_mean_zeta[3] + group_mean_zeta[4]) / 2;
        
        //PLACEBO GROUP effects
        
        placebo_group_effect_alpha = group_mean_alpha[1] - group_mean_alpha[3];
        placebo_group_effect_red_bias = group_mean_red_bias[1] - group_mean_red_bias[3];
        placebo_group_effect_gamma = group_mean_gamma[1] - group_mean_gamma[3];
        placebo_group_effect_rho = group_mean_rho[1] - group_mean_rho[3];
        placebo_group_effect_beta = group_mean_beta[1] - group_mean_beta[3];
        placebo_group_effect_theta = group_mean_theta[1] - group_mean_theta[3];
        placebo_group_effect_zeta = group_mean_zeta[1] - group_mean_zeta[3];
        
        //DRUG GROUP EFFECTS
        drug_group_effect_alpha = group_mean_alpha[2] - group_mean_alpha[4];
        drug_group_effect_red_bias = group_mean_red_bias[2] - group_mean_red_bias[4];
        drug_group_effect_gamma = group_mean_gamma[2] - group_mean_gamma[4];
        drug_group_effect_rho = group_mean_rho[2] - group_mean_rho[4];
        drug_group_effect_beta = group_mean_beta[2] - group_mean_beta[4];
        drug_group_effect_theta = group_mean_theta[2] - group_mean_theta[4];
        drug_group_effect_zeta = group_mean_zeta[2] - group_mean_zeta[4];
        ...
        overall_condition_effect_theta = (group_mean_theta[1] + group_mean_theta[3]) / 2 - (group_mean_theta[2] + group_mean_theta[4]) / 2;
        overall_condition_effect_zeta = (group_mean_zeta[1] + group_mean_zeta[3]) / 2 - (group_mean_zeta[2] + group_mean_zeta[4]) / 2;
        
        //CONTROL CONDITION effects
        control_condition_effect_alpha = group_mean_alpha[1] - group_mean_alpha[2];
        control_condition_effect_red_bias = group_mean_red_bias[1] - group_mean_red_bias[2];
        control_condition_effect_gamma = group_mean_gamma[1] - group_mean_gamma[2];
        control_condition_effect_rho = group_mean_rho[1] - group_mean_rho[2];
        control_condition_effect_beta = group_mean_beta[1] - group_mean_beta[2];
        control_condition_effect_theta = group_mean_theta[1] - group_mean_theta[2];
        control_condition_effect_zeta = group_mean_zeta[1] - group_mean_zeta[2];
        
        //EXPERIMENTAL GROUP CONDITION effects
        experim_condition_effect_alpha = group_mean_alpha[3] - group_mean_alpha[4];
        experim_condition_effect_red_bias = group_mean_red_bias[3] - group_mean_red_bias[4];
        experim_condition_effect_gamma = group_mean_gamma[3] - group_mean_gamma[4];
        experim_condition_effect_rho = group_mean_rho[3] - group_mean_rho[4];
        experim_condition_effect_beta = group_mean_beta[3] - group_mean_beta[4];
        experim_condition_effect_theta = group_mean_theta[3] - group_mean_theta[4];
        experim_condition_effect_zeta = group_mean_zeta[3] - group_mean_zeta[4];
    }
}
