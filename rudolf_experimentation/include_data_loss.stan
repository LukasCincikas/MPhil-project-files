    // ========================================================================
    // MODIFIED Core data for all models
    // ========================================================================
    ...
    real<lower=0> starting_points[N_TRIALS];
    ...
    int<lower=1, upper=8> block_number[N_TRIALS];
    int<lower=0, upper=1> subject_won[N_TRIALS];
