// cgt_romeu2020_model12_combined_no_condition.stan
// Used for winning model with 2 added parameters
// For 2 groups, no conditions data structure
...
generated quantities {
    ...
    
    {
        ...
        overall_group_effect_alpha = group_mean_alpha[1] - group_mean_alpha[2];
        overall_group_effect_red_bias = group_mean_red_bias[1] - group_mean_red_bias[2];
        overall_group_effect_gamma = group_mean_gamma[1] - group_mean_gamma[2];
        overall_group_effect_rho = group_mean_rho[1] - group_mean_rho[2];
        overall_group_effect_beta = group_mean_beta[1] - group_mean_beta[2];
        overall_group_effect_theta = group_mean_theta[1] - group_mean_theta[2];
        overall_group_effect_zeta = group_mean_zeta[1] - group_mean_zeta[2];
    }
}
